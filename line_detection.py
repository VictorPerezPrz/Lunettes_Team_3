...
if __name__ == '__main__':
	...
	Vpub = rospy.Publisher('/AutoModelMini/manual_control/speed',Int16,queue_size=1)				 
	Spub = rospy.Publisher('/AutoModelMini/manual_control/steering',Int16,queue_size=1)
