...
def callback_V(data0):
	...
	Vpub.publish(v) 
	Spub.publish(u)
	cv2.imshow("Camara",imagenT)
	cv2.waitKey(3)

if __name__ == '__main__':
	print("Equipo: 3")
	rospy.init_node('Equipo_3',anonymous=True)												
	Vpub = rospy.Publisher('/AutoModelMini/manual_control/speed',Int16,queue_size=0.5)				 
	Spub = rospy.Publisher('/AutoModelMini/manual_control/steering',Int16,queue_size=0.5)
